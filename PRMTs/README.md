...
Its three schematic figures (coordinate systems, Locator data flow, site map) are generated by the
scripts in [`../docs/figures/`](../docs/figures/) from constants in this source zip.
